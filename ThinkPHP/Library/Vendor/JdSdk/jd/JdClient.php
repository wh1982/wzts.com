...
//     	\Think\Log::record('fjson_decode($reponse) '.json_decode($reponse));
//     	\Think\Log::record('fjson_encode($reponse) '. json_encode($reponse));
//     	\Think\Log::record('fjson_encode(curl_errno($ch)) '.json_encode(curl_errno($ch)));
...
//     	\Think\Log::record('fjson_encode($httpStatusCode) '.json_encode($httpStatusCode));
