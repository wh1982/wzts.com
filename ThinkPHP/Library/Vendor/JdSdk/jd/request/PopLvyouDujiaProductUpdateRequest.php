<?php
class PopLvyouDujiaProductUpdateRequest
{
	...
	public function getProductDesc(){
	  return $this->productDesc;
                        	                   			...
                        	                   			private $productTripDesc;
    	                        
	public function setProductTripDesc($productTripDesc){
		$this->productTripDesc = $productTripDesc;
		$this->apiParas["productTripDesc"] = $productTripDesc;
	}

	public function getProductTripDesc(){
	...
	public function getPriceListJson(){
	  return $this->priceListJson;
                              ...
                              public function setDeletePriceId($deletePriceId ){
                 $this->deletePriceId=$deletePriceId;
              }

              public function getDeletePriceId(){
